...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Mengecek apakah ada tulisan ?error=unauthorized di URL
    if (searchParams.get("error") === "unauthorized") {
      alert("Akses ditolak! Silakan login terlebih dahulu untuk melihat halaman tersebut.");
      
      // (Opsional) Bersihkan URL dari tulisan ?error=unauthorized setelah alert muncul
